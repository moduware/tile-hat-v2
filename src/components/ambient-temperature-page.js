...
class AmbientTemperaturePage extends connect(store)(PageViewElement) {
	...
	render() {
		return html`
      <div>
        <a href="#" style="color:red" href="#">Ambient temp<a/>
        <br/>
...
window.customElements.define('ambient-temperature-page', AmbientTemperaturePage);
