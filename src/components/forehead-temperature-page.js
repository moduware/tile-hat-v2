...
class ForeheadTemperaturePage extends connect(store)(PageViewElement) {
	...
	render() {
      ...
      <div>
        ...
        <br/>
        <br/>
        <a style="color:red" href="#">forehead temperature<a/>
		<br/>
        <br/>
...
window.customElements.define('forehead-temperature-page', ForeheadTemperaturePage);
